...
export type TrailingIcon1IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TrailingIcon1Icon(props: TrailingIcon1IconProps) {
...
export default TrailingIcon1Icon;
/* prettier-ignore-end */
