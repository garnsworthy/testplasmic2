...
export type TrailingIcon3IconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function TrailingIcon3Icon(props: TrailingIcon3IconProps) {
...
export default TrailingIcon3Icon;
/* prettier-ignore-end */
